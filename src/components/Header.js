    ...
    return (
      <div className="header-container">
        <div className="header-container-left">
          <HeaderButton text={'home'} hoverColor={this.props.secondaryColor} link={'https://matthewjdiaz1.github.io/portfolio'} />
          ...
          <HeaderButton text={'About Us'} hoverColor={this.props.secondaryColor} link={'https://matthewjdiaz1.github.io/portfolio'} />
