    ...
    return (
      <div className="header-container">
        <div className="header-container-left">
          ...
          <HeaderButton text={'Recipes'} hoverColor={this.props.secondaryColor} link={'https://www.google.com/search?q=icecream+recepes&oq=icecream+recepes&aqs=chrome..69i57j0l7.3380j0j4&sourceid=chrome&ie=UTF-8'} />
        </div>
        <div
